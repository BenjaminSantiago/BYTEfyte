...
## What is this? 
A game/learning tool where you are presented with hexadecimal or decimal numbers and then you have to convert them to binary. 
...
- add difficulty levels (cumulative)
    ...
    - 3 --> three bit numbers (4 + 2 + 1, etc)
    - 4 --> one above or below powers of two (33, etc)
    - 5 --> "dense and sparse"
    - 6 --> fully random
